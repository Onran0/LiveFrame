...
Загружает модель и применяет её к конкретной сущности.
...
> [!NOTE]
> При загрузке файлов, содержащих в себе анимации и/или модели используется
> кэширование на основе хэширования таблицы `loadSettings`.