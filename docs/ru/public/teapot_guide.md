...
## Шаг 1: Установите LiveFrame и добавьте его в зависимости контент-пака

Скачать **LiveFrame** можно на вкладке [релизов](https://github.com/Onran0/LiveFrame/releases) - просто скачайте последнюю доступную версию.
...
## Шаг 2: Установка плагинов для Blockbench
...
## Шаг 3: Экспорт модели и анимаций
...
## Шаг 4: Добавьте текстуры в `preload.json`
...
## Шаг 7: Получите объект проигрывателя из своего компонента
...
## Шаг 9: Наслаждайтесь результатом
